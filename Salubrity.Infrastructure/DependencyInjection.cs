...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration config)
    {
        ...
        services.AddScoped<Salubrity.Application.Interfaces.Repositories.Organizations.IOrganizationDepartmentRepository, Salubrity.Infrastructure.Repositories.Organizations.OrganizationDepartmentRepository>();
        services.AddScoped<Salubrity.Application.Interfaces.Repositories.Auth.IPasswordResetTokenRepository, Salubrity.Infrastructure.Repositories.Auth.PasswordResetTokenRepository>();
        ...
        services.AddScoped<IOrganizationOverviewRepository, OrganizationOverviewRepository>();
        services.AddScoped<IHealthCampOverviewRepository, HealthCampOverviewRepository>();
        services.AddScoped<ISubcontractorOverviewRepository, SubcontractorOverviewRepository>();
        ...
        services.AddScoped<ICampStatisticsRepository, CampStatisticsRepository>();
