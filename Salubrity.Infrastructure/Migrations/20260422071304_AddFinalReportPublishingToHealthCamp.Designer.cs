...
namespace Salubrity.Infrastructure.Migrations
{
    ...
    [Migration("20260422071304_AddFinalReportPublishingToHealthCamp")]
    partial class AddFinalReportPublishingToHealthCamp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthAssessmentDynamicFieldResponse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("HealthAssessmentDynamicFieldResponses");
                });

            modelBuilder.Entity("HealthAssessmentFormResponse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("HealthAssessmentFormResponses");
                });

            modelBuilder.Entity("HealthCampTempCredential", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("HealthCampTempCredentials");
                });
            ...
            modelBuilder.Entity("Salubrity.Domain.Entities.Clinical.ServiceReferral", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("FollowUpScheduleId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("FollowUpScheduleId");

                    b.HasIndex("UrgencyId");

                    b.ToTable("ServiceReferrals");
                });
            ...
            modelBuilder.Entity("Salubrity.Domain.Entities.HealthAssesment.HealthAssessmentMetric", b =>
                {
                    ...
                    b.ToTable("HealthAssessmentMetrics");
                });
            ...
            modelBuilder.Entity("Salubrity.Domain.Entities.HealthCamps.HealthCamp", b =>
                {
                    ...
                    b.Property<DateTime?>("FinalReportsPublishedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid?>("FinalReportsPublishedById")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ParticipantPosterJti")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("SubcontractorPosterJti")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Salubrity.Domain.Entities.HealthCamps.HealthCampStationCheckIn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("HealthCampParticipantId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("HealthCampServiceAssignmentId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("HealthCampParticipantId");

                    b.HasIndex("HealthCampServiceAssignmentId");
            ...
            modelBuilder.Entity("Salubrity.Domain.Entities.Identity.OnboardingStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsRoleSpecificDataComplete")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Salubrity.Domain.Entities.Lookup.FollowUpSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Salubrity.Domain.Entities.Lookup.HealthAssessmentFormType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("HealthAssessmentFormTypes");
                });
            ...
            modelBuilder.Entity("Salubrity.Domain.Entities.Lookup.HealthMetricStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Salubrity.Domain.Entities.Lookup.Urgency", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Salubrity.Domain.Entities.Notifications.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Salubrity.Domain.Entities.Notifications.NotificationRecipient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Salubrity.Domain.Entities.Notifications.NotificationType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Salubrity.Domain.Entities.Organizations.OrganizationBranch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OrganizationId", "BranchName")
                        .IsUnique()
            ...
            modelBuilder.Entity("HealthAssessmentDynamicFieldResponse", b =>
                {
                    ...
                    b.HasOne("HealthAssessmentFormResponse", "FormResponse")
                        .WithMany("Responses")
            ...
            modelBuilder.Entity("HealthAssessmentFormResponse", b =>
                {
                    b.HasOne("Salubrity.Domain.Entities.Lookup.HealthAssessmentFormType", "FormType")
                        .WithMany()
            ...
            modelBuilder.Entity("Salubrity.Domain.Entities.Clinical.ServiceReferral", b =>
                {
                    b.HasOne("Salubrity.Domain.Entities.Lookup.FollowUpSchedule", "FollowUpSchedule")
                        .WithMany("ServiceReferrals")
                        .HasForeignKey("FollowUpScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Salubrity.Domain.Entities.Lookup.Urgency", "Urgency")
                        .WithMany("ServiceReferrals")
                        .HasForeignKey("UrgencyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FollowUpSchedule");
            ...
            modelBuilder.Entity("Salubrity.Domain.Entities.HealthAssesment.HealthAssessment", b =>
                {
                    ...
                    b.HasOne("Salubrity.Domain.Entities.Identity.Employee", "ReviewedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Salubrity.Domain.Entities.HealthCamps.HealthCampServiceAssignment", b =>
                {
                    ...
                    b.HasOne("Salubrity.Domain.Entities.Lookup.SubcontractorRole", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("Salubrity.Domain.Entities.HealthCamps.HealthCampStationCheckIn", b =>
                {
                    b.HasOne("Salubrity.Domain.Entities.Join.HealthCampParticipant", "Participant")
                        .WithMany()
                        .HasForeignKey("HealthCampParticipantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Salubrity.Domain.Entities.HealthCamps.HealthCampServiceAssignment", "Assignment")
                        .WithMany()
                        .HasForeignKey("HealthCampServiceAssignmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Salubrity.Domain.Entities.Identity.Employee", b =>
                {
                    b.HasOne("Salubrity.Domain.Entities.Organizations.OrganizationBranch", "Branch")
                        .WithMany()
            ...
            modelBuilder.Entity("Salubrity.Domain.Entities.Notifications.NotificationRecipient", b =>
                {
                    b.HasOne("Salubrity.Domain.Entities.Notifications.Notification", "Notification")
                        .WithMany("Recipients")
